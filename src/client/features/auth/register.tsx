          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl xl:text-5xl font-bold tracking-tight mb-4">
                Your ideas deserve
                <br />
                <span className="text-primary">to be shared</span>
              </h1>
              <p className="text-lg text-muted-foreground">
                A simple platform for writers to craft, publish, and share their
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Write freely</h3>
                  <p className="text-sm text-muted-foreground">
                    A distraction-free editor designed for your creative flow
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Publish instantly</h3>
                  <p className="text-sm text-muted-foreground">
                    Share your thoughts with readers whenever inspiration
                    strikes
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Build your voice</h3>
                  <p className="text-sm text-muted-foreground">
                    Connect with readers who appreciate your unique perspective
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Start writing in less than a minute
            </p>
          </div>
