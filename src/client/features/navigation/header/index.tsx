              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                    ...
                    <ListItem href="/catalogue/stories" title="Stories">
                      Personal narratives, fiction, and creative writing.
                    </ListItem>
                    <ListItem href="/catalogue/minds" title="Minds">
                      Philosophy, psychology, and deep thinking.
                    </ListItem>
                  </ul>
                </NavigationMenuContent>
              </NavigationMenuItem>
